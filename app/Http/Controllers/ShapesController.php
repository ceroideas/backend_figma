...
class ShapesController extends Controller
{
    ...
    public function recursiveCalculate($newNode,$j)
    {
            ...
            if (gettype($nodeId) == 'integer') {
                ...
                if ($node->type == 1) {
                    if (!in_array($node->id, $this->nodesActive)) {
                      ...
                      // csvData
                      if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $value];}
                        ...
                        switch ($node->distribution_shape[0]['name']) {
                            case 'Uniforme':
                                $randomNumber = $this->uniformOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $randomNumber];}
                            ...
                            case 'Triangular':
                                $triangularNumber = $this->triangularOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $triangularNumber];}
                            ...
                            case 'Binominal':
                                $binomialNumber = $this->binomialOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $binomialNumber];}
                            ...
                            case 'Lognormal':
                                $lognormalNumber = $this->lognormalOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $lognormalNumber];}
                            ...
                            case 'Geometric':
                                $geometricNumber = $this->geometricalOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $geometricNumber];}
                            ...
                            case 'Weibull':
                                $weibullNumber = $this->weibullOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $weibullNumber];}
                            ...
                            case 'Beta':
                                $betaNumber = $this->betaOperation(
                                  ...
                                  $formula[] = '(' . $betaNumber . ')';
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $betaNumber];}
                            ...
                            case 'Hypergeometric':
                                $hypergeometricNumber = $this->hypergeometricOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $hypergeometricNumber];}
                            ...
                            case 'Poisson':
                                $poissonNumber = $this->poissonOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $poissonNumber];}
                            ...
                            case 'Normal':
                                $randomNumberNormal = $this->normalOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $randomNumberNormal];}
                            ...
                            case 'Exponencial':
                                $randomNumberExponential = $this->exponentialOperation(
                                  ...
                                  // csvData
                                  if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $randomNumberExponential];}
                    ...
                    // csvData
                    if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$node->name => $operation];}
        ...
        // csvData
        if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$newNode->name => $operation];}
    ...
    public function generateSimulation(Request $r)
    {
        ...
        for ($j=0; $j < $this->simulationNumber; $j++) { 
            ...
            // csvData
            if (!isset($this->csvData[$j])) {$this->csvData[$j] = [$tierCero->name => $operation];}
